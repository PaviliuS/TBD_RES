...
namespace TBD_RES
{
    public partial class Form1 : Form
    {
        ...
        {
            sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["RESDB"].ConnectionString);
            sqlConnection.Open();
        ...
        {
            procedure($"EXECUTE p_sales @new_course = N'{textBox3.Text}', @new_client = N'{textBox4.Text}', @new_extras = N'{textBox5.Text}', @new_employee = N'{textBox6.Text}';");
        }
